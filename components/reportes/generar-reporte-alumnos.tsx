...
interface GenerarReporteAlumnosProps {
  alumnos: Alumno[]
}

export default function GenerarReporteAlumnos({ alumnos }: GenerarReporteAlumnosProps) {
    ...
    const html = `
      ...
      <body>
        ...
        <div class="stats">
          ...
          <p><strong>Activos:</strong> ${alumnos.filter(a => a.activo).length}</p>
          <p><strong>Inactivos:</strong> ${alumnos.filter(a => !a.activo).length}</p>
        </div>
